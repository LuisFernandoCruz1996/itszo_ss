  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand border-bottom navbar-dark" style="background-color: #1B396A; ">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar elevation-4" style="background-color: #716F70;">
    <!-- Brand Logo -->
