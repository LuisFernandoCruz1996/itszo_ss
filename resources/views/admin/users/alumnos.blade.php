...
@section('title1') 
 <a href="{{route('alumnos')}}" style="color: #1B396A;">Alumnos registrados: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('alumnos.alumnosmujeres')}}" style="color: #1B396A;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('alumnos.alumnoshombres')}}" style="color: #1B396A;">Hombres: {{$hombres}}</a>
@endsection
