...
@section('title', 'ANEXO XXIV. Formato de autoevaluación cualitativa del prestador de Servicio Social')
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Cumplí en tiempo y forma con las actividades encomendadas  alcanzando los objetivos.',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Trabajé en equipo y me adapté a nuevas situaciones.',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Mostré liderazgo en las actividades encomendadas',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Organicé mi tiempo y trabajé de manera proactiva.',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Interpreté la realidad y me sensibilicé aportando soluciones a la problemática con la actividad complementaria.',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Realicé sugerencias innovadoras para beneficio o mejora del programa en el que participa.',
          is3D: true,
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Tuve iniciativa para ayudar en las actividades encomendadas y mostré espíritu de servicio.',
          is3D: true,
        };
