...
@section('title1')
<a href="{{route('seguimiento.indextsms6')}}" style="color: #1B396A;">Alumnos de TSM semestre 6: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('seguimiento.indextsms6mujeres')}}" style="color: #1B396A;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('seguimiento.indextsms6hombres')}}" style="color: #1B396A;">Hombres: {{$hombres}}</a>
@endsection
