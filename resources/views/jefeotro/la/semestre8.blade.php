...
@section('title1')
<a href="{{route('seguimiento.indexlas8')}}" style="color: #1B396A;">Alumnos de LADMON semestre 8: {{$alumnostotal}}</a>
@endsection

@section('title2')
<a href="{{route('seguimiento.indexlas8mujeres')}}" style="color: #1B396A;">Mujeres: {{$mujeres}}</a>
@endsection

@section('title3')
 <a href="{{route('seguimiento.indexlas8hombres')}}" style="color: #1B396A;">Hombres: {{$hombres}}</a>
@endsection
